...
collection: research
permalink: /research/bayesian-fads
...
I had the opportunity to work with **Prof. Jeremy Price, School of Education, Indiana University**, as part of the **Faculty Assistance in Data Science – IU Research program** during **Summer 2024**, developing an analytics framework to quantify and visualize research impact.
...
- Integrated **R and Python** with **Streamlit** using **rpy2**, allowing execution of **50+ R visualization scripts dynamically** within a web app.  
...
This work translated qualitative partnership activities into **structured, numeric evaluations**, helping institutions identify alignment, ripple effects, and priority areas for growth in community-engaged research.

**Skills:** R, Python, Streamlit, rpy2, Bayesian Analysis, Network Modeling, Graph Theory, Data Visualization, Survey Analytics, Interactive Web Apps, Plotly, ggplot2  

**GitHub Repositories:**  
- [FADS Summer 2024](https://github.com/nehachede/FADS-Summer24) – My implementation and Streamlit app for visualizing engagement metrics.  
